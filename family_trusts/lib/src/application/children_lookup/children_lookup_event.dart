...
class ChildrenLookupEvent with _$ChildrenLookupEvent {
  ...
  const factory ChildrenLookupEvent.locationSelected(Location location) = LocationSelected;
  const factory ChildrenLookupEvent.rendezVousChanged(DateTime dateTime) = RendezVousChanged;
