          ...
          builder: (context, state) {
            return state.maybeMap(
              ...
              simpleSuccessEventState: (simpleSuccessEventState) {
                final List<Either<InvitationFailure, Invitation>> invitationsResult =
                    simpleSuccessEventState.items as List<Either<InvitationFailure, Invitation>>;

                final invitations = invitationsResult.where((element) => element.isRight()).map((e) => e.toOption().toNullable()!).toList();
