...
part of 'child_lookup_details_dto.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

ChildLookupDetailsDTO _$ChildLookupDetailsDTOFromJson(
    ...
    ChildLookupDetailsDTO(
      ...
      events: (json['events'] as List<dynamic>?)
          ?.map((e) => ChildLookupEventDTO.fromJson(e as Map<String, dynamic>))
          .toList(),
      status: json['status'] as String?,
      reason: json['reason'] as String?,
    );

Map<String, dynamic> _$ChildLookupDetailsDTOToJson(
        ChildLookupDetailsDTO instance) =>
    <String, dynamic>{
