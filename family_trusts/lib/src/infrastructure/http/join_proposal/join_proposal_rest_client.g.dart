...
class _JoinProposalRestClient implements JoinProposalRestClient {
  ...
  Future<List<JoinFamilyProposalDTO>> findArchivedByPersonId(personId) async {
    ...
    final _result = await _dio.fetch<List<dynamic>>(
        _setStreamType<List<JoinFamilyProposalDTO>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
            .compose(
              _dio.options,
              '/proposals/person/${personId}/archived',
  ...
  Future<JoinFamilyProposalDTO> findPendingByPersonId(personId) async {
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<JoinFamilyProposalDTO>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
            .compose(
              _dio.options,
              '/proposals/person/${personId}/pending',
              queryParameters: queryParameters,
              data: _data,
            )
            .copyWith(baseUrl: baseUrl ?? _dio.options.baseUrl)));
  ...
  Future<JoinFamilyProposalDTO> decline(
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(
      ...
      extra: _extra,
            ...
            .compose(
              _dio.options,
              '/proposals/${joinFamilyProposalId}/decline/${memberId}',
              queryParameters: queryParameters,
              data: _data,
            )
            .copyWith(baseUrl: baseUrl ?? _dio.options.baseUrl)));
  ...
  Future<JoinFamilyProposalDTO> accept(
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(
      ...
      extra: _extra,
            ...
            .compose(
              _dio.options,
              '/proposals/${joinFamilyProposalId}/accept/${memberId}',
              queryParameters: queryParameters,
              data: _data,
            )
            .copyWith(baseUrl: baseUrl ?? _dio.options.baseUrl)));
